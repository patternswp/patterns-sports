 ...
 * Slug: patterns-sports/header-absolute
 * Categories: header
...
?>
<!-- wp:group {"className":"patterns-sports-header at-pos at-z-idx","style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group patterns-sports-header at-pos at-z-idx">
