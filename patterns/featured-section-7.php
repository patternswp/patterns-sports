 ...
 * Slug: patterns-sports/featured-section-7
 * Categories: text, feature
...
<p class="has-text-align-left" style="letter-spacing:1px;text-transform:uppercase"><?php esc_html_e( 'Our Success Story', 'patterns-sports' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"left"} -->
<h2 class="wp-block-heading has-text-align-left"><?php esc_html_e( 'We can Help You to Become stronger', 'patterns-sports' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Contact us', 'patterns-sports' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p class="has-x-large-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( '8945', 'patterns-sports' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":5} -->
<h5 class="wp-block-heading"><?php esc_html_e( 'Happy Clients', 'patterns-sports' ); ?></h5>
<!-- /wp:heading -->
